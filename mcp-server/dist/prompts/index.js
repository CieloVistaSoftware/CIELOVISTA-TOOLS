export function registerPrompts(server) {
    server.prompt("greeting", "A friendly greeting prompt for the CieloVista project.", async () => {
        return {
            messages: [
                {
                    role: "assistant",
    ...
    server.prompt("project-summary", "Summarizes what the CieloVista project is about.", async () => {
        return {
            messages: [
                {
                    role: "assistant",
