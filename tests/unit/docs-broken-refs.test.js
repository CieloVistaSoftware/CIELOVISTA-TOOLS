/**
 * tests/unit/docs-broken-refs.test.js
 * Structural tests for src/features/docs-broken-refs.ts
 * Run: node tests/unit/docs-broken-refs.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/docs-broken-refs.js');
...
test('source file has copyright header', () => {
    const src = path.join(__dirname, '../../src/features/docs-broken-refs.ts');
