/**
 * tests/unit/playwright-runner.test.js
 * Structural tests for src/features/playwright-runner.ts
 * Run: node tests/unit/playwright-runner.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/playwright-runner.js');
...
test('source file has copyright header', () => {
    const src = path.join(__dirname, '../../src/features/playwright-runner.ts');
