/**
 * tests/unit/file-list-viewer.test.js
 * Structural tests for src/features/file-list-viewer.ts
 * Run: node tests/unit/file-list-viewer.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/file-list-viewer.js');
