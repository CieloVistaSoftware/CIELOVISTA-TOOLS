/**
 * tests/unit/daily-audit.test.js
 * Structural tests for src/features/daily-audit/
 * Run: node tests/unit/daily-audit.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out/features/daily-audit/index.js');
...
test('source index.ts exists', () => {
    ...
    assert.ok(fs.existsSync(src), 'daily-audit/index.ts missing');
});
