/**
 * tests/unit/mcp-server-scaffolder.test.js
 * Structural tests for src/features/mcp-server-scaffolder.ts
 * Run: node tests/unit/mcp-server-scaffolder.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/mcp-server-scaffolder.js');
...
console.log('\nmcp-server-scaffolder unit tests\n' + '─'.repeat(50));
...
test('source file has copyright header', () => {
    const src = path.join(__dirname, '../../src/features/mcp-server-scaffolder.ts');
