/**
 * tests/unit/doc-intelligence.test.js
 * Structural tests for src/features/doc-intelligence/
 * Run: node tests/unit/doc-intelligence.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/doc-intelligence/index.js');
...
test('source index.ts exists', () => {
    const src = path.join(__dirname, '../../src/features/doc-intelligence/index.ts');
    assert.ok(fs.existsSync(src), 'doc-intelligence/index.ts missing');
});
