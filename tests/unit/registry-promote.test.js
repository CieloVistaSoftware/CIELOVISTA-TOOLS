/**
 * tests/unit/registry-promote.test.js
 * Structural tests for src/features/registry-promote.ts
 * Run: node tests/unit/registry-promote.test.js
 */
'use strict';
...
const OUT = path.join(__dirname, '../../out-test/features/registry-promote.js');
...
Module._load = function(req, parent, isMain) {
    if (req === 'vscode') {
        return {
            ...
            window:    { showErrorMessage() {}, showInformationMessage() {}, showQuickPick: async () => undefined, withProgress: async (_, fn) => fn({ report() {} }), createOutputChannel: () => ({ appendLine() {}, show() {}, dispose() {} }) },
...
test('exports promoteFolder function', () => assert.strictEqual(typeof mod.promoteFolder,  'function'));
test('source file has copyright header', () => {
    const src = path.join(__dirname, '../../src/features/registry-promote.ts');
