/**
 * tests/unit/test-coverage-auditor.test.js
 * Structural tests for src/features/test-coverage-auditor.ts
...
const OUT = path.join(__dirname, '../../out/features/test-coverage-auditor.js');
...
console.log('\ntest-coverage-auditor unit tests\n' + '─'.repeat(50));
...
test('source file has copyright header', () => {
    const src = path.join(__dirname, '../../src/features/test-coverage-auditor.ts');
