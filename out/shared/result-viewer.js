...
exports.showCommandResult = showCommandResult;
exports.disposeResultViewer = disposeResultViewer;
/**
 * result-viewer.ts
 *
...
function _ensurePanel() {
    ...
    _panel = vscode.window.createWebviewPanel('cvsResultViewer', '📋 CieloVista Results', { viewColumn: vscode.ViewColumn.Two, preserveFocus: true }, { enableScripts: true, retainContextWhenHidden: true });
