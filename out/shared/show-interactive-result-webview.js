...
exports.showInteractiveResultWebview = showInteractiveResultWebview;
/**
 ...
 */
function showInteractiveResultWebview(opts) {
    // Create a new webview panel beside the current editor
    const panel = vscode.window.createWebviewPanel('interactiveResultWebview', opts.title, vscode.ViewColumn.Beside, { enableScripts: true });
...
//# sourceMappingURL=show-interactive-result-webview.js.map