...
- [Playwright Test Setup](../../src/features/playwright-check.README.md) — Checks every registered project for a working Playwright setup and fixes each gap with one click.
