...
**Date:** 2026-05-15 21:47:35
**Project:** cielovista-tools
**Strategy:** Tiered Testing (Tiers 1–5)

> **ℹ️ Coverage Status:** 55 of 57 features have tests.**
...
| `unit\runtime-assets.test.js` | 18 | — |
...
| `regression\REG-025-npm-output-failed-jobs.test.js` | 4 | — |
| `regression\REG-025-npm-output-routing-and-timing.test.js` | 4 | — |
...
| `regression\REG-046-filelist-run-test-context-menu.test.js` | 2 | — |
...
| `regression\REG-051-npm-scripts-ready-uses-latest-cards.test.js` | 5 | — |
| `regression\REG-052-package-scripts-ready-handshake.test.js` | 8 | — |
| `regression\REG-053-2-npm-script-collection.test.js` | 3 | — |
| `regression\REG-053-npm-scripts-all-shown.test.js` | 6 | — |
...
**Generated:** 2026-05-15T02:47:35.908Z
