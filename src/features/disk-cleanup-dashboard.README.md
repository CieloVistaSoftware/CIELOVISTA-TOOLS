...
|---|---|---|
| `cvs.diskcleanup.openDashboard` | DiskCleanUp: Open Dashboard | — |
| `cvs.diskcleanup.consoleMode` | DiskCleanUp: Console Mode | — |
...
status: active
tags: [cleanup, cvs.diskcleanup.openDashboard, dashboard, disk]
