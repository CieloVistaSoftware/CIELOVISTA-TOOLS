...
const FEATURE_EXPLANATIONS: Record<string, string> = {
    ...
    readmeCompliance: 'Scans README files across registered projects, scores them against the CieloVista standard, and offers reviewable fixes.',
    docsBrokenRefs: 'Scans markdown docs across registered projects for missing image/doc links and suggests likely target files.',
...
export const FEATURE_REGISTRY: FeatureEntry[] = [
    ...
    { key: 'readmeCompliance',       label: 'README Compliance',           description: 'Scan and fix README files against the CieloVista standard' },
    { key: 'docsBrokenRefs',         label: 'Docs Broken References Scanner', description: 'Scan docs for missing images and dead markdown links' },
