...
**The contract** (#707, #708): three hand-written fields at the top of the file. Anything derivable (path, dates, category, tags, numbered ids) is not typed into a document. `scripts/docs-sync.js` enforces it on docs/ and src/.
